...
export default function CustomCursor() {
  ...
  return (
    <>
      ...
      <motion.span
        aria-hidden="true"
        className="pointer-events-none fixed left-0 top-0 z-[99] h-9 w-9 -translate-x-1/2 -translate-y-1/2 rounded-full border border-nebula-blue-glow/70 shadow-glow"
